                ...
                <div class="card-body">
                    ...
                    <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row mb-4" hidden>
                            <label for="email" class="col-md-3 form-label">Blog Email</label>
                            <div class="col-md-9">
                                <input class="form-control" value="{{Auth::user()->email}}" id="email" name="email" placeholder="Blog name" type="text" readonly>
                                <span class="text-danger">{{$errors->has('name')?$errors->first('name'):''}}</span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{Auth::user()->name}}" id="author" name="author" placeholder="Author name" type="text" readonly>

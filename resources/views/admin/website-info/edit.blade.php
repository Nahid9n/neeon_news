    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Website Infos</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col-lg-10 shadow">
            <div class="card shadow">
                <div class="card-header justify-content-center border-bottom">
                    <h2 class="fw-bold">Edit Website Infos Form</h2>
                    <hr>
                </div>
                <div class="card-body">
                    <p class="text-primary fw-bold fs-5">{{session('message')}}</p>
                    <form action="{{route('websiteInfos.update',$websiteInfo->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            <label for="email" class="col-md-3 form-label">Email Address</label>
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->email}}" id="email" name="email" placeholder="Email Address" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->email_other}}" id="email_other" name="email_other" placeholder="Other Email Address" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->address}}" id="address" name="address" placeholder="Address" type="text" >
                                <span class="text-danger">{{$errors->has('name')?$errors->first('name'):''}}</span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->mobile_number}}" id="mobile_number" name="mobile_number" placeholder="Mobile Number" type="text" >
                                <span class="text-danger">{{$errors->has('name')?$errors->first('name'):''}}</span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->mobile_optional}}" id="mobile_optional" name="mobile_optional" placeholder="Other Mobile Number" type="text" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->facebook}}" id="facebook" name="facebook" placeholder="facebook " type="text" >
                                <span class="text-danger">{{$errors->has('mobile_number')?$errors->first('mobile_number'):''}}</span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->twitter}}" id="twitter" name="twitter" placeholder="twitter " type="text" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->instagram}}" id="instagram" name="instagram" placeholder="instagram " type="text" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->linkedIn}}" id="linkedIn" name="linkedIn" placeholder="linkedIn " type="text" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->google_plus}}" id="google_plus" name="google_plus" placeholder="google_plus " type="text" >
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" value="{{$websiteInfo->youtube}}" id="youtube" name="youtube" placeholder="youtube " type="text" >
                        ...
                        <div class="row mb-4">
                            <div class="form-group ps-0 d-lg-flex col-md-12">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img width="200" src="{{asset($websiteInfo->logo)}}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="form-group ps-0 d-lg-flex col-md-12">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img width="200" src="{{asset($websiteInfo->banner)}}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="short_about_us" name="short_about_us" placeholder="short about us" type="text" cols="10" rows="5">{{$websiteInfo->short_about_us}}"</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="about_us" class="col-md-3 form-label">About Us</label>
                            <div class="col-md-9">
                                <textarea class="summernote" id="about_us" name="about_us" placeholder="about_us" type="text" cols="10" rows="5">{!! $websiteInfo->about_us !!}"</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="map" class="col-md-3 form-label">Map</label>
                            <div class="col-md-9">
                                <textarea name="map" class="form-control" id="map" cols="10" rows="2">{{$websiteInfo->map}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="radio" class="col-md-3 form-label">status</label>
                            <div class="col-md-9">
                                <input class="" id="published" name="status" {{$websiteInfo->status == 1 ?'checked':''}} type="radio" value="1"><label for="published">published</label>
                                <input class="mx-2" id="Unpublished" name="status" type="radio"  {{$websiteInfo->status == 0 ?'checked':''}} value="0"><label for="Unpublished">unpublished</label>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="radio" class="col-md-3 form-label"></label>
                            <div class="col-md-9">
                                <button class="btn btn-primary" type="submit">Update websiteInfos</button>
                            </div>
                        </div>

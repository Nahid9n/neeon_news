        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <i class="fa-solid side-menu__icon fa-person-chalkboard"></i>
                        <span class="side-menu__label">Account Settings</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="{{route('user-profile')}}" class="slide-item">Profile</a></li>
                        <li><a href="{{route('user-profile.edit-profile')}}" class="slide-item">Edit Profile</a></li>
                        <li><a href="{{route('user-profile.timeline')}}" class="slide-item">Timeline</a></li>
                        <li><a href="{{route('user-profile.account-setting')}}" class="slide-item">Account setting</a></li>
                    </ul>
                </li>
            </ul>

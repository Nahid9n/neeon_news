...
@section('title','Sponsored Blog Page')
@section('body')
                            ...
                            @foreach($sponsoredBlogs as $sponsoredBlog)
                                <div class="col-md-4 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="800ms">
                                    <div class="rt-post-overlay rt-post-overlay-md layout-6">
                                        <div class="post-img">
                                            <a href="{{route('sponsored.details',['id'=>$sponsoredBlog->id])}}" class="img-link">
                                                <img src="{{asset($sponsoredBlog->image)}}" alt="post-xl_37" width="900" height="600">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                            <a href="{{route('category',['id'=>$sponsoredBlog->category_id])}}" class="life-style">{{$sponsoredBlog->category->name}}</a>
                                            <h3 class="post-title">
                                            ...
                                            <div class="post-meta">
                                                <ul>
                                                    <li>
                                                <span class="rt-meta">
                                                   by <a href="" class="name">{{$sponsoredBlog->author}}</a>
                                                </span>
                                                    </li>
                                                    <li>
                                                <span class="rt-meta">

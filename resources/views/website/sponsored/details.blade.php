...
@section('title','Sponsored Blog Detail Page')
@section('body')
                    ...
                    <div class="rt-left-sidebar-sapcer-5">
                        ...
                        <div class="rt-main-post-single grid-meta">
                            ...
                            <div class="post-header">
                                <span class="rt-cat-primary">{{$sponsoredBlog->category->name}}</span>
                                <h2 class="title">
                                    {{$sponsoredBlog->name}}
                                </h2>
                                <div class="post-meta">
                                    <ul>
                                        <li>
                                          <span class="rt-meta">
                                             by <a href="author.html" class="name">{{$sponsoredBlog->author}}</a>
                                          </span>
                                        </li>
                                        <li>
                                          <span class="rt-meta">
                            ...
                            <figure class="post-img text-center">
                                <img src="{{asset($sponsoredBlog->image)}}" alt="post-img" width="700" height="500">
                            </figure>
                            <!-- end post-img -->
                            ...
                            <div class="post-body">
                                <p class="rt-dropcap-style-1">
                                    {!! $sponsoredBlog->long_description !!}
                                </p>
                                <!-- ad banner -->
                            ...
                            <div class="author-box-style-1 mb--50">
                                ...
                                <div class="author-content">
                                    <h3 class="author-name">{{$sponsoredBlog->author}}</h3>
                                    <span class="author-role">$sponsoredBlog->user->designation</span>
                                    <p class="user-desc">
                                        ...
                                        <form action="{{route('comment.store')}}" class="comments-form-style-1" method="post">
                                            ...
                                            <div class="col-xl-4">
                                                <div class="rt-form-group" hidden>
                                                    ...
                                                    <input placeholder="" value="{{$sponsoredBlog->id}}" type="number" name="sponsored_blog_id" readonly>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                ...
                                                <div class="rt-post-grid grid-meta">
                                                    <div class="post-img">
                                                        <a href="single-post1.html">
                                                            <img src="{{asset($relatedBlog->image)}}" alt="post" width="551"
                                                                 height="431">
                                                        </a>
                                                    </div>
                                                    <div class="post-content">
                                                        <a href="" class="rt-post-cat-normal">{{$relatedBlog->category->name}}</a>
                                                        <h4 class="post-title">
                                                            <a href="single-post1.html">
                                                                {{$relatedBlog->name}}
                                                            </a>
